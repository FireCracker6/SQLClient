...
-- get all from addresses and get all from customer tables
SELECT * FROM Addresses
SELECT * FROM Customers

-- getr all customers + addresses from database
SELECT 
...
-- get a specific customer + address from database based on email
SELECT 
 c.Id, c.FirstName, c.LastName, c.Email, c.PhoneNumber,
 a.StreetName, a.PostalCode, a.City
